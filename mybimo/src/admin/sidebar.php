                ...
                <ul class="nk-menu">
                    ...
                    <li class="nk-menu-item">
                        <a href="admin/index.php" class="nk-menu-link">
                            ...
                            <span class="nk-menu-text">Dashboard</span><span class="nk-menu-badge">MY BIMO</span>
                        </a>
                    </li><!-- .nk-menu-item -->
                    <li class="nk-menu-heading">
                    ...
                    <li class="nk-menu-item has-sub">
                        <a href="#" class="nk-menu-link nk-menu-toggle">
                            ...
                            <span class="nk-menu-text">Master Materi</span>
                        </a>
                        <ul class="nk-menu-sub">
                            <li class="nk-menu-item">
                                <a href="admin/index.php?materi" class="nk-menu-link"><span
